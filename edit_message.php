...
<div class="row">
    <div class="contents">
    <h1 class="heading"> <span>Update Message</span> <br><br> </h1>
    <form action="<?php print htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST" class="contacts_form">
        ...
        <input type="text" id="fn" placeholder="Fullname" name="fullname" required="<?php print $spot_msg_row["sender_name"];?>"><br><br>

        <label for="em">Email Address:</label><br>
        <input type="email" id="em" placeholder="Email Address" name="email_address" required="<?php print $spot_msg_row["sender_name"];?>"><br><br>

        <label for="sb">Subject:</label><br>
        <select name="subject_line" id="sb" required>
            <option value="<?php print $spot_msg_row["subject_line"];?>"></option>
